...
export const AvailabilityContactModal: React.FC<AvailabilityContactModalProps> = ({
  ...
  const handleAvailabilityUpdate = (updatedProfile: UserProfile) => {
    // Update state without closing modal
  ...
  const handleAvailabilitySave = async (updatedProfile: UserProfile) => {
  ...
  return (
    <>
      ...
      <AvailabilityModal
        ...
        profile={tempProfile}
        loading={false}
        onProfileUpdate={handleAvailabilityUpdate}
