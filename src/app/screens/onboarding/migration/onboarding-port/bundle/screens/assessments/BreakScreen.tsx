...
export function BreakScreen() {
  ...
  useEffect(() => {
    ...
    if (profile?.assessmentsStarted || profile?.currentAssessment) {
      ...
      router.replace("/onboarding/assessments/intro");
    }
  }, [
    loading,
  ...
  return (
    <SafeAreaView style={styles.container} edges={["top", "left", "right"]}>
      ...
      <Text style={styles.body}>
        These aren't personality quizzes — they're validated research
      ...
      <Text style={styles.meta}>Estimated time: 12 minutes</Text>
      <Text style={styles.meta}>Number of assessments: 2</Text>
