...
const FAIL_BADGE_TEXT = '#fecaca';
const FAIL_BADGE_BORDER = 'rgba(248, 113, 113, 0.45)';
...
/**
 * Standard applicants who did not meet the community bar (true fail or “almost” from the gate).
 * Same layout family as `PostInterviewPassedScreen`, with a coach consult path via Calendly.
 */
export const PostInterviewFailedScreen: React.FC<{
  navigation: any;
  ...
  const confirmAndRetakeInterview = () => {
    ...
    showConfirmDialog({ title: 'Retake test?', message: msg, confirmText: 'Retake' }, run);
  };
  ...
  const copyReferralCode = async () => {
    ...
    try {
      ...
      if (__DEV__) console.warn('[PostInterviewFailed] clipboard', e);
    }
  };

  const openCoachCalendly = () => {
    void Linking.openURL(COACH_CALENDLY_URL);
  };
    ...
    <SafeAreaContainer style={{ backgroundColor: BG, flex: 1 }}>
      ...
      >
        ...
        <Text style={styles.sub}>
          Thank you for giving the interview your full effort. Based on the evaluation, the bar for Amoraea&apos;s
          small community is very high, and at this time we can&apos;t extend an invitation. This isn&apos;t a
          statement about your worth—only a fit for what we&apos;re building together.
        </Text>
        <View style={styles.card}>
          <View style={styles.badgeRow}>
            ...
            <View style={styles.badgeFail}>
              <Text style={styles.badgeTextFail}>Not admitted</Text>
            </View>
          </View>
          ...
          <View style={styles.bullets}>
            {[
              "Our process looks for specific signals of relationship readiness; many strong people sit just below that bar.",
              "You still have a path: talk with a coach (below) to discuss your result or next steps.",
              'If you want to try again later, plan for six months after your interview date — we reset your attempt and scoring data once that window has passed.',
            ].map((line) => (
          ...
          {myReferralCode ? (
            <View style={styles.referFriendSection}>
              ...
              <Text style={styles.referFriendTitle}>Share Amoraea with a friend</Text>
              <Text style={styles.referFriendBody}>
                If you know someone who would be a fit, you can still share your personal code with them.
              </Text>
...
const styles = StyleSheet.create({
  ...
  badgeFail: {
    ...
    borderRadius: 999,
    borderWidth: 1,
    borderColor: FAIL_BADGE_BORDER,
    backgroundColor: FAIL_BADGE_BG,
  },
  badgeTextFail: {
    fontFamily: FONT_BODY,
    fontSize: 13,
    fontWeight: '600',
    color: FAIL_BADGE_TEXT,
    letterSpacing: 0.3,
  },
  bullets: { gap: 12 },
