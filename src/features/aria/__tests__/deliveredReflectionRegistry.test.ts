...
describe('M4/M5 handoff reflection dedup', () => {
  ...
  it('omits threshold→M5 reflection when boundary reflections are disabled', () => {
    const grudge =
  ...
  it('omits threshold→M5 reflection when only scenario_boundary slot has similar text', () => {
