...
• BLAME-SHIFT / ACCOUNTABILITY DEFLECTION (score accountability LOW — typically mid-low or lower when this is the main move): Responsibility is redirected onto the other person; the user does not own their impact, emotional contribution, behavior, or role in the dynamic. The primary explanatory frame is the other person's failing, inadequacy, or wrongdoing. Examples: "He's the one who started it"; "She made me do that"; "If he hadn't said that none of this would have happened"; "I had nothing to do with how it turned out." Example: "Sarah should have just told me what she needed instead of expecting me to read her mind" — no ownership; the problem is placed on the partner.
...
• BOUNDARY EXPRESSION / NEEDS STATEMENT (do NOT treat as deflection; may indicate healthy self-awareness): The user states what they need, want, value, or how they evaluate feedback. This is honest communication about their own position, not avoidance of responsibility. Boundary statements can coexist with genuine accountability — a person can own their part in a conflict AND state what they needed from the other person. Examples: "I would have appreciated if you were more open to my feedback"; "I don't take criticism seriously from people who haven't experienced my work"; "What I needed in that moment was someone to believe in me"; "I set a limit on how much I was willing to tolerate." These are expressions of inner experience and standards, not low-accountability evidence by themselves.

• DIRECT OR BLUNT COMMUNICATION (do NOT penalize by tone alone): Directness is a communication style, not an accountability gap. A line like "I don't take your opinion seriously if you haven't experienced what I do" can be a coherent position about feedback credibility rather than defensiveness, especially when it is framed as the user's own standard or experience rather than as proof the other person is wholly at fault.

• SELF-AWARE QUALIFICATION AFTER A DIRECT JUDGMENT (positive accountability signal): When the user makes a direct or harsh judgment and immediately qualifies it with self-awareness, credit the qualification as accountability. Examples: "I see him as very immature — but that's probably my own projection" demonstrates ownership and perspective-taking; "I got triggered because he hit something true — I was just starting out and insecure about my coaching" is explicit ownership of the emotional contribution to the conflict. Score these as accountability present, not absent.

DECISION TEST: Before scoring accountability low, ask: is the user avoiding examining their own contribution, or are they expressing their own needs and position clearly? Avoidance of self-examination is low accountability. Clarity about one's own experience, standards, boundaries, or feedback criteria is not. Does the accountability-relevant stretch include genuine ownership of the user's own contribution (behavior, miss, emotional contribution, or impact) before or alongside the request? If yes, the request for clarity is additive — score ownership at full strength and do not penalize accountability for asking how to follow through. If no ownership is present and the request functions mainly to shift the burden entirely onto the partner, score as blame-shift.
...
- **Repair gesturing vs. concrete direction:** Evaluate whether the response contains at least one identifiable repair action — something the person would **say**, **do**, or **change** — regardless of how many words it takes to express it. The test is **not** whether the answer is concise; it is whether a specific action is present anywhere in the response.
  - **Repair gesturing (typically score 2–4):** No specific action is identifiable anywhere despite length. The response consists entirely of restating the problem ("there's clearly something going on that James doesn't understand"), willingness without content ("I would try to figure it out", "we would work through it"), questions with no follow-through action ("I would ask her what she needs" with nothing about what happens next), or circular language that loops back to describing the problem rather than addressing it.
  - **Concrete repair direction (typically score 6–9):** At least one specific action is identifiable somewhere, even if surrounded by hedging or filler. Credit concrete actions such as naming what they would say to the person, naming a behavioral change they would commit to, naming an emotional acknowledgment they would offer, or naming a concrete next step in the conversation. A long-winded answer that eventually lands on "I would apologize for jumping straight to the details and ask her how she'd like to celebrate" contains concrete repair action and should generally score at least 6–7 on repair if not undermined elsewhere.
