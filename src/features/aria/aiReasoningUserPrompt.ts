/**
 * Alpha-only: prompt builder for interview AI reasoning narrative.
 */
...
import { getAiReasoningStructuralEnforcementInstructions } from '@features/reports/reportNarrativeStructuralEnforcement';
import {
...
export const SYSTEM_PROMPT = `You are a senior clinical assessment analyst and
...
export type GenerateAIReasoningOptions = {
  ...
  maxAttempts?: number;
  evidenceContext?: NarrativeEvidenceContext | null;
  /** When true, always compact transcript before building the prompt. */
