...
In **your** spoken lines, when you refer to anyone in these situations, use **only** these names. Do **not** invent, substitute, merge, or “correct” names (e.g. do not use “Reese,” “Rhys,” “Riley,” or any name not listed above). Do not reuse names across scenarios (e.g. never call Scenario B characters by Scenario A names). If the participant uses a wrong name, you may gently echo their wording in the **reflection** of their turn only when quoting them — do not introduce wrong names yourself.
`;
