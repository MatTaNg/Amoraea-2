...
export const INTERVIEW_PIPELINE_DEBUG_STEPS: readonly string[] = [
  'After Moment 5 (second personal question): final closing + [INTERVIEW_COMPLETE] only — no further questions; closing should still include a specific transcript callback per CLOSING_LINE_INSTRUCTIONS.',
