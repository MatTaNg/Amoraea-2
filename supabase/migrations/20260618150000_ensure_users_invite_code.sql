-- Remotes that skipped 20260209000004_add_invite_code.sql lack invite_code; PostgREST then errors (PGRST204).
-- Idempotent with the original migration.
...
GRANT EXECUTE ON FUNCTION get_user_id_by_invite_code(TEXT) TO anon, authenticated;
