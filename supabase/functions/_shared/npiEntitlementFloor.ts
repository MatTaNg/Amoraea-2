export { NPI_ENTITLEMENT_FLOOR_THRESHOLD } from '../../../src/config/psychometrics/floors.ts';
import { NPI_ENTITLEMENT_FLOOR_THRESHOLD } from '../../../src/config/psychometrics/floors.ts';
